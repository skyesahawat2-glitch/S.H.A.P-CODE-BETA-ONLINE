...
int main (void)
{
	...
	sleep(1);
	  system("cls");
       ...
       Beep(400,600);
log:
  char user[10], pass[10],direction2[12],direction3[3],direction5[20],name1[20],surename1[20],direction12[20],directionx[20],direction_tl[20],direction_link[20],music_band[20],direction_smpcmd[40];
  ...
  if(strcmp(user,user1)==0 && strcmp(pass,pass1)==0)
   {
       ...
       else if (strcmp(direction2,direction17)==0)
       {
		...
		else if (strcmp(ps,direction_git)==0)
		{
		system("cls");
		system("git status");
        system("cmd");
	   ...
	   goto start;
	   	...
	   	else if (strcmp(direction2,direction_note)==0)
	   {
	   system("cls");
	   system("Notepad.exe");
	   printf("open windows notepad\n");
	   system("pause");
	   system("cls");
	   goto start;
	   }
	   ...
	   else if (strcmp(direction2,direction_cls)==0)
	   {
	   system("cls");
	   goto start;
	   }
