...
log:
  ...
  char direction22[]="tls",direction23[]="j",direction24[]="ttie",direction_a[]="a",direction_d[]="d",direction_guide[]="guide",forgot[]="forgot",music_band1[]="ajr",pb1[]="iphone",direction_ep[]="access_ep";
  ...
  if(strcmp(user,user1)==0 && strcmp(pass,pass1)==0)
   {
       ...
       printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n                               camera not found                                      \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
       printf("-----------------------------------------------------------------------------\n");
       printf("helper:oops look like we have a signal problem\n");
       printf("-----------------------------------------------------------------------------\n");
       system("pause");
       system("cls");
       goto help;
	   ...
	   else if (strcmp(direction2,direction_ep)==0)
	   {
	   system("cls");
	   printf("hello world");
       }
